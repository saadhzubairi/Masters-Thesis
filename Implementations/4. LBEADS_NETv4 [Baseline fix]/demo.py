...
def main():
    ...
    axes2[0].plot(signal.noise, 'gray', linewidth=0.3, alpha=0.5, label='Noise')
    ...
    # Panel 2: Observed signal with baseline highlighted
    axes2[1].plot(signal.y, 'b', linewidth=0.5, alpha=0.7, label='Observed (y = x + f + noise)')
    axes2[1].plot(signal.f_true, 'm-', linewidth=2, label='True Baseline')
    axes2[1].set_title('Observed Signal with True Baseline Highlighted')
